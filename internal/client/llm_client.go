// ========== DOSYA: sentiric-agent-service/internal/client/llm_client.go (TAM VE DOĞRU İÇERİK) ==========
package client
...
func NewLlmClient(rawBaseURL string, log zerolog.Logger) *LlmClient {
	...
	// --- DEĞİŞİKLİK: Şema kontrolü eklendi ---
...
// ... (Generate fonksiyonu aynı kalır) ...
